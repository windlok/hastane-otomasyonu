...
<nav class="navbar">
    <div class="navbar-inner">
        ...
        <div class="navbar-right">
            ...
            <span class="user-greeting">Hoş geldiniz, <strong><?php echo htmlspecialchars($_SESSION['kullanici_adsoyad']); ?></strong></span>
            <?php endif; ?>
            <a href="islem.php?islem=cikis" class="btn-logout">
                Çıkış Yap
            </a>
        </div>
    </div>
